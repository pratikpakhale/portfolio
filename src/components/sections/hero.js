...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Pratik Pakhale.</h2>;
  const three = <h3 className="big-heading">Learning while Building.</h3>;
  const four = (
    <>
      <p>
        I graduated from{' '}
  ...
  const five = (
    <a className="email-link" href="/archive" rel="noreferrer">
      My Project Archive →
    </a>
  );
